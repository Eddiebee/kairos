...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/toastify-js/src/toastify.js":[function(require,module,exports) {
/*!
 * Toastify js 1.11.2
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/httpService.js":[function(require,module,exports) {
"use strict";
...
navigator.geolocation.getCurrentPosition(function (position) {
  ...
  var myKey = _config.default.MY_KEY,
      city = "port harcourt"; // let url = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${myKey}`;

  var url = "https://api.openweathermap.org/data/2.5/weather?lat=".concat(lat, "&lon=").concat(lon, "&appid=").concat(myKey);

  _httpService.default.get(url).then(function (response) {
    ...
    icon.innerHTML = "<i class=\"owi owi-".concat(response.data.weather[0].icon, " owi-10x\"></i>");
  ...
  setInterval(function () {
    var date = new Date();
    document.getElementById("time").innerHTML = "<p class=\"fw-bold fs-4\">".concat(date.toLocaleTimeString(), "</p>");
  }, 1000);
...
},{"toastify-js":"../node_modules/toastify-js/src/toastify.js","./httpService":"js/httpService.js","./../../config":"../config.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
