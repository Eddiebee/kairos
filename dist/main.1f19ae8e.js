...
//     .then((data) => {
//       if (data.cod === "404") alert(`${data.cod} ${data.message}`);
//       newData.data = { ...data };
//       return data;
//       // console.log(data);
//     });
...
},{"../config":"../config.js","axios":"../node_modules/axios/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
