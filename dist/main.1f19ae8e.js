...
var myKey = _config.default.MY_KEY,
    city = "calabar";
var url = "https://api.openweathermap.org/data/2.5/weather?q=".concat(city, "&appid=").concat(myKey); // console.log(url);

fetch(url).then(function (res) {
  return res.json();
}).then(function (data) {
  console.log(data); // document.getElementById("app").innerHTML = `<p>${data.name}</p>`;
});
var components = {
...
},{"../config":"../config.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
